  ...
  return (
    <div className="w-full flex items-center justify-between gap-3">
      ...
      <div className=" flex items-center justify-center gap-4">
        <div className=" flex items-center gap-3 px-4 py-2 bg-lightOverlay backdrop-blur-md rounded-md shadow-md">
          <MdSearch className=" to-gray-400 text-2xl" />
          <input
            type="text"
            placeholder="Search here"
            className=" border-none outline-none bg-transparent w-32 text-base font-semibold text-textColor"
          />
          <BsToggles2 className="text-gray-400 text-2x1" />
        </div>
        <motion.div
          {...buttonClick}
