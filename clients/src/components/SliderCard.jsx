...
const SliderCard = ({ data, index }) => {
  ...
  return (
    <div className="  bg-lightOverlay hover:drop-shadow-lg backdrop-blur-md rounded-xl flex justify-between items-center relative px-4 py-2 w-full md:w-340 md:min-w-350 gap-3">
      ...
      <div className="relative pt-12">
        ...
        <p className="text-lg font-semibold text-red-500 flex items-center justify-center gap-1 ">
          <HiCurrencyRupee className="text-red-500 text-2xl" />{" "}
